...
public class Operation implements Serializable {
    ...
    /**
     * @param numOperation represents the operation number
     * @param amount       the amount to be withdrawn
     * @param balance      the account balance after the operation
     ...
     *
     * @param balance represents the balance to set
     */
     ...
     *
     * @param type represents the operation type
     */
     ...
     *
     * @param numOperation representing the number to set
     */
     ...
     *
     * @param date representing the date to set
     */
     ...
     *
     * @param amount a double representing the amount to set
     */
