...
public class Account implements Serializable {
     ...
     *
     * @param accountNumber is the identifier of the account
     * @param openingDate   the creation date of the account
     * @param operations    a list of the account operations
     ...
     *
     * @param accountNumber a string representing the value to set
     */
     ...
     *
     * @param openingDate a date representing the value to set
     */
     ...
     *
     * @param operations represents an operation list to set
     */
     ...
     *
     * @param balance is a double representing the balance to set
     */
